...
def make_map():
    ...
    stars=''.join(f'<circle cx="{x}" cy="{y}" r="{r}"/>' for x,y,r in [(22,18,1.2),(177,38,1.6),(239,22,1),(272,125,1.3),(185,164,1.6),(18,157,1.3),(70,150,1),(55,302,1.1),(176,244,1),(488,161,1.2),(660,130,1.2),(389,141,1),(656,372,1.6),(591,442,1.2),(426,491,1),(198,445,1.5),(242,324,1.1),(475,279,1)])
    night=f'<g class="map-night-sky" aria-hidden="true" pointer-events="none">{stars}<path class="map-crescent" d="M225 29 A22 22 0 1 0 240 64 A19 19 0 0 1 225 29"/><path class="map-comet" d="M140 126 l70 -38"/><path class="map-star-cross" d="M194 190 v12 m-6 -6 h12 M370 34 v10 m-5 -5 h10 M619 393 v12 m-6 -6 h12"/></g>'
    svg=f'''<svg class="fukui-map" viewBox="0 0 700 540" aria-labelledby="map-svg-title map-svg-desc"><title id="map-svg-title">福井県の北部・嶺北を巡る3日間の冒険マップ</title><desc id="map-svg-desc">北が上。Day 1は福井から東の勝山、北西のあわら。Day 2は西の東尋坊と三国から南東のESHIKOTO・永平寺を経て福井。Day 3は南東の一乗谷と福井を往復。写真とアイコンは線で実際の代表位置に結んでいます。色の線は訪問順で、道路の経路ではありません。</desc><defs>{clips}{arrows}<pattern id="map-grain" width="8" height="8" patternUnits="userSpaceOnUse"><circle cx="2" cy="2" r=".6" fill="#254b3e" opacity=".07"/></pattern></defs><rect class="map-sea" width="700" height="540" fill="#d8e9e7"/>{land}<rect width="700" height="540" fill="url(#map-grain)" pointer-events="none"/>{night}<g aria-hidden="true"><text class="map-display-type" x="399" y="70">FUKUI</text><text class="map-subtitle" x="404" y="93">A LITTLE ADVENTURE</text><text class="sea-label" x="26" y="250">日本海</text><text class="map-small map-sea-meta" x="26" y="267">SEA OF JAPAN</text><text class="region-label" x="514" y="116">石川県</text><text class="region-label" x="538" y="496">福井県・嶺北</text></g>{lines}{markers}<g id="map-traveler" class="map-traveler" visibility="hidden" pointer-events="none" aria-hidden="true"><circle r="14"/><circle r="5"/></g><g class="map-north" transform="translate(665 36)"><text text-anchor="middle" y="-12">N</text><path d="M0,0 V30 M-5,8 L0,0 L5,8"/></g><g class="map-inset" transform="translate(25 474) scale(.47)"><path d="{inset_path}" fill="#c6d1b7" stroke="#869d80" stroke-width="1.3"/><rect x="51" y="4" width="68" height="47" fill="#ae663322" stroke="#a46840" stroke-width="2" stroke-dasharray="3 2"/><text x="155" y="36" class="map-small">福井県全体</text><text x="155" y="59" class="map-small">今回の旅は嶺北へ</text></g><g class="map-scale" transform="translate(535 515)"><path d="M0,-5 V0 H101.6 V-5" stroke="#62796b" fill="none"/><text x="50.8" y="16" text-anchor="middle" class="map-small">約10 km</text></g></svg>'''
