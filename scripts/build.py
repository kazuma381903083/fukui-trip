...
<script src="trip-data.js" defer></script><script src="app.js" defer></script>
</head>
<body>
<a class="skip-link" href="#journey">旅程へスキップ</a>
<header class="site-header"><a class="brand" href="#top" aria-label="ふくいのしおり 表紙へ"><span class="brand-mark">福</span><span>ふくいのしおり<small>FUKUI TRAVEL JOURNAL</small></span></a><nav aria-label="メインナビ"><a href="#journey">三日間の旅程</a><a href="#places">訪れる場所</a><a href="#preparation">旅の準備</a></nav><span class="header-date">2026.09.21 — 23</span></header>
<main id="top">
...
<section class="section-wrap" id="route"><div class="section-heading"><div><p class="eyebrow">02 / FOLLOW THE THREAD</p><h2>海へ、里へ。旅の道すじ。</h2></div><p>場所を選ぶと、住所と移動の案内へ。<br>経路ボタンからGoogle マップを開けます。</p></div><div class="routes">{{ROUTES}}</div></section>
...
assets=['./','./index.html','./style.css','./trip-data.js','./app.js','./manifest.webmanifest','./credits.html','./assets/tojinbo.webp','./assets/eiheiji.webp','./assets/icon-192.png','./assets/icon-512.png']
